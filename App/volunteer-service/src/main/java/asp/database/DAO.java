...
public class DAO {
    ...
    public List<Volunteer> getAllVolunteers() {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            while (rs.next()) {
                ...
                String strbirthday = rs.getString("birthday");
                LocalDateTime birthday = LocalDate.parse(strbirthday).atStartOfDay();
    ...
    public void addVolunteer(String usernameLinked, Double points, LocalDateTime birthday, Departament departament) {
